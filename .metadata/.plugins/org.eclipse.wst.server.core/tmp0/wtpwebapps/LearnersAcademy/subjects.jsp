...
<body>
	...
	<h1 class="display-5 mt-5" style="text-align: center;">Subjects</h1>

	<div class="container mt-5 col-6">
		<div class="row .col-sm|md|lg|xl">

			<figure class="figure col themed-grid-col">
				<a href="show_Subjects.jsp"><img
					src="images/Subjects/View Master List.png" height=150px></a>
			...
			<figure class="figure col themed-grid-col">
				<a href="add_Subject.jsp"><img
					src="images/Subjects/Add Subject.png" height=150px></a>
				<figcaption class="figure-caption mt-3">
					<h4>Add Subject</h4>
				</figcaption>
			</figure>
			...
			<figure class="figure col themed-grid-col">
				<a data-bs-toggle="modal" data-bs-target="#exampleModal" href="#"><img
					src="images/Subjects/Remove Subject.png" height=150px></a>
				<!-- Modal -->
				<div class="modal fade" id="exampleModal" tabindex="-1"
					aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-lg">
						<form action="<%=request.getContextPath()%>/removeSubjects"
							method="post">
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<h6 class="modal-title" id="exampleModalLabel">Please
										select the Subject(s) that you wish to remove</h6>
										...
										<tbody>
											...
											<tr>
												<td align="center"><input type="checkbox"
													name="removesubject" value="<%=sub.getSubjectID()%>"></td>

												<td><%=Sno%></td>
												<td><%=sub.getSubjectID()%></td>
												<td><%=sub.getSubjectName()%></td>
												<td><%=sub.getClasses()%></td>
												<td><%=sub.getSection()%></td>
 		...
 		<figure class="figure col themed-grid-col">
				<a href="<%=request.getContextPath()%>/AssignSubject.jsp"><img src="images/Classes/Assign subject.png"
					height=150px></a>
				<figcaption class="figure-caption mt-3">
